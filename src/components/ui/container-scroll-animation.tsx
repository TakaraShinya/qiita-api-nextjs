...
export const ContainerScroll = ({
  ...
  return (
    ...
    >
      ...
      >
        <Header style={headerStyle} titleComponent={titleComponent} translate={translate} />
        <Card rotate={rotate} scale={scale} style={cardStyle} translate={translate}>
          {children}
        </Card>
      </div>
    </div>
...
export const Header = ({ translate, titleComponent, style }: HeaderProps) => {
  return (
    <motion.div
...
export const Card = ({ rotate, scale, children, style }: CardProps) => {
  const { motionDiv, div } = style ?? {};
